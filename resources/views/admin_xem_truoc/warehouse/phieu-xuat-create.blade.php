                    ...
                    <form id="form-tao-phieu-xuat-full">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="ly_do" class="form-control" id="px-ly-do-full"
                                    placeholder="Lý do xuất hàng...">
                            </div>
                        </div>
        ...
        $(function() {
            ...
            $('#btn-luu-phieu-xuat-full').click(function() {
                ...
                $.ajax({
                    ...
                    error: function(x) {
                        hienThongBaoXuatTao('danger', x.responseJSON?.message ||
                            'Đã xảy ra lỗi.');
                    }
                });
            });
        ...
        function loadFefoForVariant(row, variantId, soLuong) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    fefoCell.html(
                        `<select class="form-select form-select-sm fefo-lo-select-full" required>${options}</select>`
                        );
                },
                error: function() {
