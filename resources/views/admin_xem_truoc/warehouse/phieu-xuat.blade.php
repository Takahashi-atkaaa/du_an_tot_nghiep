...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        ...
        @if(userHasPermission('xuat_hang'))
        ...
        const html = items.map(item => {
            ...
            return `<tr>
                ...
                <td class="text-center">
                    <a href="{{ url('admin/kho-hang/phieu-xuat') }}/${item.id}" class="btn btn-sm btn-outline-primary" title="Xem chi tiết phiếu xuất"><i class="fas fa-eye"></i></a>
                    ${@json(userHasPermission('xuat_hang')) ? `<button class="btn btn-sm btn-outline-warning btn-sua-px" data-id="${item.id}"><i class="fas fa-edit"></i></button>` : ''}
                </td>
            </tr>`;
        }).join('');
