...
<div class="container-fluid">
    <h4 class="mb-4">Đổi / Trả hàng - Hóa đơn #HD{{ str_pad($hoaDon->id, 4, '0', STR_PAD_LEFT) }}</h4>
...
<div class="container-fluid">
    ...
    <form action="{{ route('nhan-vien.hoa-don.xu-ly-doi-tra', $hoaDon->id) }}" method="POST" id="doiTraForm">
        @csrf
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 text-end">
                        ...
                        <a href="{{ route('nhan-vien.hoa-don.chi-tiet', $hoaDon->id) }}" class="btn btn-secondary me-2">Hủy bỏ</a>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function fetchProducts(q) {
            const url = `{{ route('nhan-vien.hoa-don.search-product', [], false) }}?q=${q}`;
            fetch(url, {
                headers: {
