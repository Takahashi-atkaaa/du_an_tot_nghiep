...
$searchProductRoute = $isAdmin ? route('admin.hoa-don.search-product', [], false) : route('nhan-vien.hoa-don.search-product', [], false);
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <a href="{{ $showRoute }}" class="btn btn-secondary me-2">Hủy bỏ</a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateLoiQtyRow(row) {
            ...
            if (loiCheckbox.checked) {
                ...
                if (loiQtyInput.value === '' || loiQtyInput.value === '0') {
                    loiQtyInput.value = qtyInput.value || 0;
                }
            } else {
        ...
        function fetchProducts(q) {
            const url = `{{ $searchProductRoute }}?q=${q}`;
            fetch(url, {
                headers: {
