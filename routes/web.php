...
Route::middleware([KTVaiTro::class])->group(function () {
    ...
    // Đổi trả hàng
    Route::get('/admin/hoa-don/search-product', [HoaDonController::class, 'searchProduct'])
        ->name('admin.hoa-don.search-product');
    Route::get('/admin/hoa-don/{id}/doi-tra', [HoaDonController::class, 'formDoiTra'])
        ->name('admin.hoa-don.doi-tra');
    Route::post('/admin/hoa-don/{id}/doi-tra', [HoaDonController::class, 'xuLyDoiTra'])
        ->name('admin.hoa-don.xu-ly-doi-tra');
