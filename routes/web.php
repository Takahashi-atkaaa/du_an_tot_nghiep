...
// BỌC LỚP NGOÀI CÙNG: Yêu cầu bắt buộc phải đăng nhập mới được vào trong
Route::middleware(['auth.dangnhap.admin'])->group(function () {

    // =========================================================
    // NHÓM 1: CHỈ DÀNH RIÊNG CHO ADMIN
    // (Chỉ user có cột vai_tro là 'admin' mới vào được)
    // =========================================================
    Route::middleware(['kiem_tra_vai_tro:admin'])->group(function () {
    ...
    // =========================================================
    // NHÓM 2: DÀNH CHO ADMIN VÀ TRƯỞNG CA
    // (Truyền 2 tham số, ai có 1 trong 2 quyền này đều vào được)
    // =========================================================
    Route::middleware(['kiem_tra_vai_tro:admin,truong_ca'])->group(function () {

    });
    // =========================================================
    // NHÓM 3: CHO PHÉP CẢ 3 VAI TRÒ (ADMIN, TRƯỞNG CA, NHÂN VIÊN)
    // (Thường là các trang chung như xem lịch làm việc, thông tin cá nhân)
    // =========================================================
    Route::middleware(['kiem_tra_vai_tro:admin,truong_ca,nhan_vien'])->group(function () {
                // Trang doi mat khau
